...
function requestNextRound() {
    try {
        ...
        if (settings.format === 'mix_americano') { 
            ...
            if (mC !== fC) { alert("KLAIDA: Mix formatui reikia vienodo vyrų i moterų skaičiaus!"); return; } 
        }
